  ...
  return (
    <>
      <header className="sticky top-0 z-50 w-full border-b border-slate-200/80 bg-white/90 backdrop-blur-md transition-all">
        ...
        {mobileMenuOpen && (
          <div className="xl:hidden border-b border-slate-200 bg-white px-4 pt-2 pb-6 space-y-2">
              ...
              {navLinks.map((link) => {
                ...
                return (
                  <Link
                    ...
                    className="flex items-center gap-2 rounded-lg p-2.5 text-xs font-semibold text-slate-700 hover:bg-emerald-50 hover:text-emerald-700"
                  >
